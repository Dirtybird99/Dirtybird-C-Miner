...
#ifdef DIRTYBIRD_OS_WIN
#    define APP_OS "Windows"
#elif defined DIRTYBIRD_OS_IOS
#    define APP_OS "iOS"
#elif defined DIRTYBIRD_OS_MACOS
#    define APP_OS "macOS"
#elif defined DIRTYBIRD_OS_ANDROID
#    define APP_OS "Android"
#elif defined DIRTYBIRD_OS_LINUX
#    define APP_OS "Linux"
#elif defined DIRTYBIRD_OS_FREEBSD
...
#ifdef DIRTYBIRD_ARM
#   define APP_ARCH "ARMv" STR2(DIRTYBIRD_ARM)
#else
