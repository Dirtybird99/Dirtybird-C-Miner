...
namespace astro_branched_zOp {
  ...
  void op25(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: XOR popcnt, rol3, rolv, sub(x^97) - with zero handling
    astro_branched_simd::op25_simd(worker, data, old);
  }
  ...
  void op38(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: srlv(x&3), rol3, XOR popcnt, rolv - with zero handling
    astro_branched_simd::op38_simd(worker, data, old);
  }
  ...
  void op44(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: XOR popcnt x2, rol3, rolv - with zero handling
    astro_branched_simd::op44_simd(worker, data, old);
  }
  ...
  void op51(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: XOR p2, XOR rol4 x2, rol5 - with zero handling
    astro_branched_simd::op51_simd(worker, data, old);
  }
  ...
  void op53(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: mul2, XOR popcnt, XOR rol4 x2 - fully vectorized
    astro_branched_simd::op53_simd(worker, data, old);
  }
  ...
  void op55(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: reverse bits, XOR rol4 x2, rol1 - with zero handling
    astro_branched_simd::op55_simd(worker, data, old);
  }
  ...
  void op188(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: XOR rol4(prev), XOR popcnt, XOR rol4 x2 - fully vectorized
    astro_branched_simd::op188_simd(worker, data, old);
  }
  ...
  void op208(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: mul2, add, srlv(x&3), rol3 - fully vectorized
    astro_branched_simd::op208_simd(worker, data, old);
  }
  ...
  void op249(workerData &worker, __m256i &data, __m256i &old, int wIndex) {
    // SIMD version: reverse bits, XOR rol4 x2, rolv - fully vectorized
    astro_branched_simd::op249_simd(worker, data, old);
  }
