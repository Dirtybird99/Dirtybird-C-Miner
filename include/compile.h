...
#define DIRTYBIRD_TARGETS /* __attribute__ ((target_clones ("arch=x86-64-v4", "arch=x86-64-v3", "arch=x86-64-v2", "arch=x86-64", "arch=alderlake", "default"))) */
...
#define DIRTYBIRD_TARGET_CLONE(NAME, RET_TYPE, ARGS, BODY, ...) \
...
#define DIRTYBIRD_FEATURES_ZNVER1  "sse4.2,popcnt,avx,avx2,bmi,bmi2,fma"
#define DIRTYBIRD_FEATURES_ZNVER4  "sse4.2,popcnt,avx,avx2,bmi,bmi2,fma,avx512f,avx512dq,avx512bw,avx512vl,avx512vbmi,avx512vbmi2,avx512vnni,avx512bitalg"
#define DIRTYBIRD_FEATURES_ZNVER5 \
...
#define DIRTYBIRD_TARGETS_X86_AVX2    "avx2", DIRTYBIRD_FEATURES_ZNVER1
#define DIRTYBIRD_TARGETS_X86_AVX512  "avx512f", DIRTYBIRD_FEATURES_ZNVER4, DIRTYBIRD_FEATURES_ZNVER5
#define DIRTYBIRD_TARGETS_X86_AVX512BW  "avx512f,avx512bw", DIRTYBIRD_FEATURES_ZNVER4, DIRTYBIRD_FEATURES_ZNVER5