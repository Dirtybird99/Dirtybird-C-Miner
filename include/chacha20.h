...
#define DIRTYBIRD_TARGETS_X86_CHACHA512  "avx512f,avx512dq,avx512bw", DIRTYBIRD_FEATURES_ZNVER4, DIRTYBIRD_FEATURES_ZNVER5
  ...
  DIRTYBIRD_TARGET_CLONE(
    ...
    ;,
    "sse2", "avx2", DIRTYBIRD_TARGETS_X86_CHACHA512
  )
  DIRTYBIRD_TARGET_CLONE(
    ...
    (
      ...
      int rounds),
    ;,
    "ssse3", "avx2"//, DIRTYBIRD_TARGETS_X86_CHACHA512  // Added AVX-512 targets
  )
#endif
